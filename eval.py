...
from metrics.BERTScore import bert_score
from metrics.BLEU4 import calculate_bleu
from metrics.CIDEr_D import cide_r
from metrics.METEOR import meteor_m
from metrics.MoverScore import *
from metrics.ROUGE_L import rouge_l
from metrics.SPICE import calc_spice
...
def get_explanation(p, dataloader):
    _m, idx = p.max(0)
    return dataloader.dataset.label2ans[idx.item()]
...
if __name__ == '__main__':
    ...
    model = build_merge(eval_dset, model_hps).to(device)
